# Использование (введите команду ниже в терминал)
...
model_name = 'maps2.model'

# берём пути к изображениям и рандомно перемешиваем
print("[INFO] loading images...")
# imagePaths = sorted(list(paths.list_images(args["dataset"])))
imagePaths = sorted(list(paths.list_images("myDataset")))
random.seed(42)
...
# (trainX, testX, trainY, testY) = train_test_split(data, test_size=0.2, random_state=42)
